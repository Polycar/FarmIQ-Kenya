...
with tab_farmer:
    ...
    with st.expander("🛠️ Advanced Settings & Officer Login"):
        ...
        with sf2:
            ...
            st.info("System Online | Scientific Engine v43")
...
if is_officer:
    with tab_officer:
        st.error("🚀 SYSTEM VERSION 49 - DATA LINK FIXED")
        st.title("📊 Dashboard")
        ...
        if run_scan == "Yes - Run National Scan":
            ...
            # Results logic
            national_results = []
            all_counties = engine.data['County'].unique()
            pbar = st.progress(0)
