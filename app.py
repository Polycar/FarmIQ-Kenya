    ...
    if "result" in st.session_state:
        ...
        if "error" in result:
            ...
            if ai_key:
                ...
                st.info("💡 **Want an Expert Briefing?** Scroll down to **Advanced Settings** at the bottom of this page and enter a Gemini API Key to enable the AI Agronomist layer.")
